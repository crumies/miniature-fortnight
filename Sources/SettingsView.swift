        ...
        NavigationView {
            List {
                ...
                Section("Developer Actions") {
                    Button("Check Live Activity Status") {
                        ble.liveActivityDebugStatus()
                    }

                    Button("Force Live Activity Update") {
                    ...
                    Toggle("Show PiP button placeholder", isOn: $settings.hudShowPiPButton)
                }

                Section("Demo Controls") {
                    Slider(value: $ble.demoThrottle, in: 0...1) {
                        Text("Throttle")
                    }
                    Slider(value: $ble.demoBrake, in: 0...1) {
                        Text("Brake")
                    }
                    Picker("Demo mode", selection: $ble.demoSelectedMode) {
